            ...
            <div className="container py-24 px-6 md:px-20">
                <div className="flex flex-col md:flex-row justify-between gap-4 items-center">
                    <div className="flex flex-col text-center md:text-left">
                        ...
                        <div className="mt-5 relative flex justify-center md:justify-start">
                            ...
                            <button className="absolute text-white rounded-full border-2 font-semibold px-6 md:px-10 py-3 md:py-5 bg-lime-600 border-amber-400 right-8 md:right-[170px] hover:bg-amber-400 transition ease-in-out duration-300 focus:outline-none focus:ring focus:ring-gray-300">Submit Now</button>
                        </div>
                    </div>
                    <div className=" w-[52%]" > 
                        <CarouselImage />
