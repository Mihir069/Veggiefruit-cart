...
const ShopDetails = () => {
    return (
        <div className="container px-3 py-10 md:py-20">
            <div className="px-4 md:px-20 py-5 grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="col-span-3 py-3">
                    <ShopDetailProduct/>
                </div>
                <div className="col-span-1 w-full">
                    <div className="flex flex-row items-center border border-slate-400 rounded-lg w-full mb-4 md:mb-0">
